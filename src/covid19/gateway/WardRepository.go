...
func (dbRepo *DatabaseRepository) GetAundhBannerWardCaseByCreateDate(createDate string, endDate string) (*database.AundhBaner, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.AundhBaner{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
...
func (dbRepo *DatabaseRepository) GetBhawaniPethWardByCreateDate(createDate string, endDate string) (*database.BhawaniPeth, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.BhawaniPeth{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetBibwewadiWardByCreateDate(createDate string, endDate string) (*database.Bibwewadi, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.Bibwewadi{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetDhankawadiWardCaseByCreateDate(createDate string, endDate string) (*database.DhankawadiSahakarnagar, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.DhankawadiSahakarnagar{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetDholePatilWardCaseByCreateDate(createDate string, endDate string) (*database.DholePatil, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.DholePatil{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetHadapsarMundhwaWardCaseByCreateDate(createDate, endDate string) (*database.HadapsarMundhwa, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.HadapsarMundhwa{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetKasbaWardCaseByCreateDate(createDate string, endDate string) (*database.KasbaVisharambaghwada, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.KasbaVisharambaghwada{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetKondhwaWardCaseByCreateDate(createDate string, endDate string) (*database.KondhwaYewalewadi, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.KondhwaYewalewadi{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetKothrudWardCaseByCreateDate(createDate string, endDate string) (*database.KothrudBavdhan, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.KothrudBavdhan{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetWadgoansheriWardCaseByCreateDate(createDate string, endDate string) (*database.NagarRoadWadgoansheri, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.NagarRoadWadgoansheri{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetShivajiNagarWardCaseByCreateDate(createDate string, endDate string) (*database.ShivajiNagarGholeRoad, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.ShivajiNagarGholeRoad{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetSinhagadRoadWardCaseByCreateDate(createDate string, endDate string) (*database.SinghagadRoad, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.SinghagadRoad{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetWanawadiWardCaseByCreateDate(createDate string, endDate string) (*database.WanawadiRamtekdi, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.WanawadiRamtekdi{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetWarjeWardCaseByCreateDate(createDate string, endDate string) (*database.WarjeKarveNagar, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.WarjeKarveNagar{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetYerwadaWardCaseByCreateDate(createDate string, endDate string) (*database.YerwadaKalasDhanori, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.YerwadaKalasDhanori{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
...
func (dbRepo *DatabaseRepository) GetPuneRuralWardCaseByCreateDate(createDate string, endDate string) (*database.PuneRural, error) {
	...
	err := dbRepo.GetDBHandle().Model(domain.PuneRural{}).Where("date(created_at) >= ? and date(created_at) <= ?", createDate, endDate).Find(&DBWardCase).Error
	return &DBWardCase, err
}
